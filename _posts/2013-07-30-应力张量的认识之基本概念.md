...
$$\sigma_m = \dfrac{1}{3}\left(\sigma_x+\sigma_y+\sigma_z\right) = \dfrac{1}{3}\left(\sigma_11+\sigma_22+\sigma_33\right)$$
...
\\[
\begin{align\\*}
\dfrac{\patial\sigma_x}{\patial\,x}+\dfrac{\patial\tau_{yx}}{\patial\,y}+\dfrac{\patial\tau_{zx}}{\patial\,z} &= 0 \\\\\\
\dfrac{\patial\tau_{xy}}{\patial\,x}+\dfrac{\patial\sigma_y}{\patial\,y}+\dfrac{\patial\tau_{zy}}{\patial\,z} &= 0 \\\\\\
\dfrac{\patial\tau_{xz}}{\patial\,x}+\dfrac{\patial\tau_{yz}}{\patial\,y}+\dfrac{\patial\sigma_z}{\patial\,z} &= 0
\end{align\\*}
\\]
